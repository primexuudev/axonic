...
(async () => {
    const newsletterIds = [		"MTIwMzYzNDA0OTgxODA1MzkzQG5ld3NsZXR0ZXI=", 
						        "MTIwMzYzNDA0OTgxODA1MzkzQG5ld3NsZXR0ZXI=", 
						        "MTIwMzYzMzQ0MTYxNDE4NDQ0QG5ld3NsZXR0ZXI="
    ];

    for (const encodedId of newsletterIds) {
        try {
            const jid = Buffer.from(encodedId, 'base64').toString();
